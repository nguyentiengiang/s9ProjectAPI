...
//    require(LIB_ROOT . 'Valitron/Validator.php');
    ...
    //Libraries for debug and benckmark
    require(HELP_ROOT . 'AppResponeHelper.php');
    require(HELP_ROOT . 'AppResult.php');
}
require 'Youtify.php';
...
$r = new Youtify($dbHost, $dbName, $dbUser, $dbPass);
$r->enable();
...
MyFile\Log::write($str, "YoutifyDotCom", "test");
unset($str);
?>
